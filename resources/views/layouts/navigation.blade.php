            ...
            <div class="flex items-center">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6 gap-x-6">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 dark:text-gray-300 dark:hover:text-gray-200 dark:focus:text-gray-200 dark:focus:border-gray-200 transition duration-150 ease-in-out">
